...
public static class MainNotes
{
    public static void Show()
    {
        ...
        Date.Show();
        Console.WriteLine();
        IEnumerableNotes.Show();
        Console.WriteLine();
        NullableStructsNotes.Show();
        ValueTypesContainingReferenceTypes.Show();
        Console.WriteLine();
        CharNotes.Show();
        Console.WriteLine();
        PrimitiveVsNonPrimitive.Show();
        Console.WriteLine();
        WhyStringsImmutable.Show();
        Console.WriteLine();
        StringBuilderNotes.Show();
        Console.WriteLine();
        ManagingLargerPrograms.Show();
        NamedArgumentsNotes.Show();
        DeconstructorsNotes.Show();
        ExtensionMethodsNotes.Show();
        Console.WriteLine();
        YieldReturnNotes.Show();
        Console.WriteLine();
